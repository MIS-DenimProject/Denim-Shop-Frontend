          ...
          <div className="p-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-[hsl(var(--color-gray-900))]">Dashboard</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div className="bg-white rounded-lg border border-[hsl(var(--color-gray-200))] p-6 shadow-sm">
                  <h3 className="text-sm font-medium text-[hsl(var(--color-gray-500))] mb-2">Production Output</h3>
                  <p className="text-3xl font-bold text-[hsl(var(--color-gray-900))]">8,567</p>
                  <p className="text-sm text-green-600 mt-2">↑ 8% from last week</p>
                </div>

                <div className="bg-white rounded-lg border border-[hsl(var(--color-gray-200))] p-6 shadow-sm">
                  <h3 className="text-sm font-medium text-[hsl(var(--color-gray-500))] mb-2">Inventory Items</h3>
                ...
                <div className="bg-white rounded-lg border border-[hsl(var(--color-gray-200))] p-6 shadow-sm">
                  <h3 className="text-sm font-medium text-[hsl(var(--color-gray-500))] mb-2">Quality Rate</h3>
                  <p className="text-3xl font-bold text-green-600">96.5%</p>
                  <p className="text-sm text-[hsl(var(--color-gray-500))] mt-2">Above target</p>
                </div>
              </div>
                ...
                <div className="bg-white rounded-lg border border-[hsl(var(--color-gray-200))] p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between py-3 border-b border-[hsl(var(--color-gray-100))] last:border-0">
                        <div>
                          <p className="font-medium text-[hsl(var(--color-gray-900))]">{order.id}</p>
                          <p className="text-sm text-[hsl(var(--color-gray-500))]">{order.customer}</p>
                        </div>
                        <div className="text-right">
                          <p className="font-semibold text-[hsl(var(--color-gray-900))]">{order.amount}</p>
                          <p className="text-xs text-[hsl(var(--color-gray-500))]">{order.status}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between py-3 border-b border-[hsl(var(--color-gray-100))] last:border-0">
                        <div className="flex items-center gap-3">
                          ...
                          ></div>
                          <div>
                            <p className="font-medium text-[hsl(var(--color-gray-900))]">{line.line}</p>
                            <p className="text-sm text-[hsl(var(--color-gray-500))]">{line.status}</p>
                          </div>
                        </div>
                        <p className="font-semibold text-[hsl(var(--color-gray-900))]">{line.output} units</p>
                      </div>
                    ))}
                  </div>
                </div>
